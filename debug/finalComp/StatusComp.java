...
abstract class StatusComp implements Posc, Flyingc{
    ...
    @braindustry.annotations.ModAnnotations.ReadOnly transient float speedMultiplier = 1, damageMultiplier = 1, healthMultiplier = 1, reloadMultiplier = 1, buildSpeedMultiplier = 1, dragMultiplier = 1;
    @braindustry.annotations.ModAnnotations.ReadOnly transient boolean disarmed = false;
