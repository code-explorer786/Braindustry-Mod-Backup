...
import static braindustry.annotations.ModBaseProcessor.packageName;
...
public class CallGenerator{
    ...
    public static void generate(ClassSerializer serializer, Seq<MethodEntry> methods) throws IOException{
        //create builder
        TypeSpec.Builder callBuilder = TypeSpec.classBuilder(ModRemoteProcess.callLocation).addModifiers(Modifier.PUBLIC);
...
//        method.addStatement("$1T packet = new $1T()", tname("mindustry.gen." + ent.packetClassName));
        method.addStatement("$1T packet = new $1T()", tname("braindustry.gen." + ent.packetClassName));
