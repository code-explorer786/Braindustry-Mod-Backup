package braindustry.annotations.misc;
...
@SupportedAnnotationTypes("braindustry.annotations.ModAnnotations.Load")
public class ModLoadRegionProcessor extends ModBaseProcessor {
    @Override
    public void process(RoundEnvironment env) throws Exception{
        TypeSpec.Builder regionClass = TypeSpec.classBuilder("ModContentRegions")
