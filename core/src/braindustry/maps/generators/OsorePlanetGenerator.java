...
public class OsorePlanetGenerator extends ModPlanetGenerator {
    ...
    public OsorePlanetGenerator() {
        ...
        arr = new Block[][]{
                ...
                {ModBlocks.magmaFloor, ModBlocks.magmaFloor, Blocks.stone, Blocks.dirt, Blocks.mud, Blocks.mud, Blocks.dirt, Blocks.mud, Blocks.stone, Blocks.stone, Blocks.dirt, ModBlocks.obsidianFloor, Blocks.dirt},
                {ModBlocks.magmaFloor, ModBlocks.magmaFloor, ModBlocks.crimzesFloor, Blocks.stone, Blocks.dirt, Blocks.dirt, Blocks.mud, Blocks.mud, Blocks.mud, Blocks.dirt, Blocks.mud, ModBlocks.crimzesFloor, ModBlocks.obsidianFloor},
    ...
    public void genTile(Vec3 position, TileGen tile) {
        ...
        //if(Simplex.noise3d(seed, 5, 0.6, 8.0, position.x, position.y, position.z) > 0.65){
