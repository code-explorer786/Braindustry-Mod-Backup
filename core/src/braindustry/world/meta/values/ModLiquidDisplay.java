...
public class ModLiquidDisplay extends Table{
    public final Liquid liquid;
    public final float amount;
    public final boolean perSecond;

    public ModLiquidDisplay(final Liquid liquid, final float amount, boolean showName) {
    this(liquid,amount,showName,false);
    }
    public ModLiquidDisplay(final Liquid liquid, final float amount, boolean showName, boolean perSecond) {
        this.liquid = liquid;
        this.amount = amount;
