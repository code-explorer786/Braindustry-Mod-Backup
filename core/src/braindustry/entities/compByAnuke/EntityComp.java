...
abstract class EntityComp{
    ...
    boolean isLocal(){
Unitc u;
        return ((Object)this) == player || ((Object)this) instanceof Unitc && (u  = (Unitc) ((Object)this))== ((Object)this)
&& u.controller() == player;
    ...
    boolean isRemote(){
Unitc u;
        return ((Object)this) instanceof Unitc && (u  = (Unitc)((Object)this))==((Object)this)
&& u.isPlayer() && !isLocal();
