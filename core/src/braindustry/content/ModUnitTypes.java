        ...
        shield = new ModUnitType("shield") {
            {
                ...
                this.engineOffset = 6;
                this.rotateSpeed = 3;
                abilities.add(new RepairFieldAbility(4f, 60f * 5, 40f), new ForceFieldAbility(40f, 10f, 120f, 60f * 8));
                this.weapons.add(
                        new ModWeapon("armor-weapon") {
                            {
                                this.top = true;
        ...
        chestplate = new ModUnitType("chestplate") {
            {
                ...
                abilities.add(new RepairFieldAbility(5f, 60f * 5, 45f), new ForceFieldAbility(55f, 9f, 300f, 60f * 8));
                this.weapons.add(
        ...
        chainmail = new ModUnitType("chainmail") {
            {
                ...
                this.commandLimit = 6;
                abilities.add(new RepairFieldAbility(6f, 60f * 5, 60f), new ForceFieldAbility(75f, 9f, 400f, 60f * 8));
                this.weapons.add(
        ...
        kraken= new ModUnitType("kraken") {
            {
                this.range = 620;
                this.constructor = Types.naval;
                this.localizedName = "[violet]Kraken";
                this.description = "[violet]Naval terror with Black Hole Reactor, built-in unit factories, lasers and rocket launchers.";
                this.health = 1065000;
                this.speed = 0.6f;
                this.accel = 0.12f;
                this.rotateSpeed = 0.4f;
                ...
                float spawnTime = 2000;
                        abilities.addAll(
                                ...
                                new BlackHoleReactorAbility(this, 30f, 35, Integer.MAX_VALUE, 15.0f, new Vec2(-32.25f, 0)),
                                new UnitSpawnAbility(ModUnitTypes.armor, spawnTime, 68.25f, -40.75f),
                                new UnitSpawnAbility(ModUnitTypes.armor, spawnTime, -68.25f, -40.75f),
                                new UnitSpawnAbility(UnitTypes.flare, spawnTime, 64.25f, -62.75f),
                                new UnitSpawnAbility(UnitTypes.flare, spawnTime, -64.25f, -62.75f)
                                );
                weapons.add(
        ...
        orochi = new ModUnitType("orochi") {
            {
                this.constructor = Types.legs;
                this.groundLayer = 60.0F;
                this.localizedName = "[violet]Orochi";
                this.description = "[violet]Huge spider unit with laser orbitals and incredible destruction abilities";
                this.health = 960000;
                this.speed = 0.5f;
                this.mechSideSway = 0.25f;
                this.hitSize = 226;
                ...
                this.commandLimit = 6;
                this.legCount = 8;
                this.legMoveSpace = 8f;
                this.legPairOffset = 9;
                this.legLength = 78;
                this.legExtension = 6;
