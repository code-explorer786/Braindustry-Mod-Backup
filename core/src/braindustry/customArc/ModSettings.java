...
public class ModSettings{
    ...
    public CheatLevel cheatLevel(){
        return CheatLevel.all[Mathf.mod(getInt("cheatLevel"), CheatLevel.all.length)];
    }
...
//            modLog("settings.ClientLoadEvent end");
    ...
    public CheatLevel cheatLevelServer(){
        return CheatLevel.all[Mathf.mod(getInt("server-var-cheatLevel"), CheatLevel.all.length)];
    }
}
